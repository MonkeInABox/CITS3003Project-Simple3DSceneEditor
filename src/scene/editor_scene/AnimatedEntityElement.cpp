...
void EditorScene::AnimatedEntityElement::add_imgui_edit_section(MasterRenderScene &render_scene, const SceneContext &scene_context) {
    ...
    ImGui::DragFloat("Diffuse Factor", &rendered_entity->instance_data.material.diffuse_tint.a, 0.05f);
    ImGui::ColorEdit3("Specular Tint", &rendered_entity->instance_data.material.specular_tint.r);
    ImGui::DragFloat("Specular Factor", &rendered_entity->instance_data.material.specular_tint.a, 0.05f);
