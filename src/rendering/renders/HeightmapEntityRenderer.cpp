...
void HeightmapEntityRenderer::EntityShader::set_instance_data(const BaseLitEntityInstanceData &instance_data) {
...
// void HeightmapEntityRenderer::VertexData::from_mesh(const VertexCollection &vertex_collection, std::vector<VertexData> &out_vertices) {
...
// void HeightmapEntityRenderer::VertexData::setup_attrib_pointers() {
