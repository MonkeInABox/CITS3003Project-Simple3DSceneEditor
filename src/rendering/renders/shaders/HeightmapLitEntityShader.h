#ifndef BASE_HEIGHTMAP_ENTITY_SHADER_H
#define BASE_HEIGHTMAP_ENTITY_SHADER_H
...
struct HeightmapEntityRenderData : public BaseLitEntityRenderData {
    HeightmapEntityRenderData(std::shared_ptr<TextureHandle> diffuse_texture, std::shared_ptr<TextureHandle> specular_map_texture);
...
class BaseHeightmapEntityShader : public BaseLitEntityShader {
  public:
    BaseHeightmapEntityShader(std::string name, const std::string &vertex_path, const std::string &fragment_path,
