...
class TextureLoader {
  ...
  public:
    ...
    std::shared_ptr<TextureHandle> load_from_file_absolute(const std::string &path, std::optional<std::string const *> name = std::nullopt, bool srgb = true, bool flip_vertical = false);
