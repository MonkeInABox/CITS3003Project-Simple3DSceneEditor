...
void MasterRenderScene::insert_entity(std::shared_ptr<HeightmapEntityRenderer::Entity> entity) {
    heightmap_entity_scene.entities.insert(std::move(entity));
}
...
bool MasterRenderScene::remove_entity(const std::shared_ptr<HeightmapEntityRenderer::Entity> &entity) {
    return heightmap_entity_scene.entities.erase(entity) != 0;
}
